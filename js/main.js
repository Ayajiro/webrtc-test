...
var useWebcamBtn = document.getElementById('useWebcam');
var useDisplayBtn = document.getElementById('useDisplay');
...
useDisplayBtn.addEventListener('click', grabDisplayVideo);
useWebcamBtn.addEventListener('click', grabWebCamVideo);
...
socket.on('created', function(room, clientId) {
  ...
  isInitiator = true;
//   alert('You are the initiator of room ' + room + '. Copy link and open in new windows to join this room.');
  grabDisplayVideo();
});
...
//   alert('You have joined room', room + '. Choose to use webcam or display to start sharing.');
  grabDisplayVideo();
});
...
function grabDisplayVideo() {
  console.log('Getting display media (video) ...');
  navigator.mediaDevices.getDisplayMedia({
    audio: false,
    video: true
  })
